...
class LoveLetter(models.Model):
  ...
  # recipient = models.ForeignKey(User, related_name='loveletters+', null=True, on_delete=models.CASCADE)
  owner = models.ForeignKey(User, related_name='loveletters_created', null=True, on_delete=models.CASCADE)
